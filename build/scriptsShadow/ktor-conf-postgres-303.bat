...
set CLASSPATH=%APP_HOME%\lib\ktor-conf-postgres-303-all.jar

@rem Execute ktor-conf-postgres-303
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %KTOR_CONF_POSTGRES_303_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%KTOR_CONF_POSTGRES_303_EXIT_CONSOLE%" exit 1
exit /b 1
